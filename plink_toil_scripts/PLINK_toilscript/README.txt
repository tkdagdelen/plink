...
* If it breaks in the middle of a run, you may need to remove the old docker container before you can try running it again. To remove the container, use Docker rm <container_name>
